...
class Decoder(nn.Module):
    def __init__(self, num_features=1664, decoder_width = 1.0):
        ...
        self.up5 = UpSample(skip_input=features // 16 + 3 , output_features=features // 32)
        # print(features//4 + 64)
        # print(features // 8)
        # print(features // 8 + 64)
        # print(features // 16)
        # print(features // 16 + 32)
    ...
    def forward(self, features):
        ...
        #     print('features[{}] = {}'.format(idx, features[idx].shape))
        # x_d5 = self.up5(x_d4, x_block0)

        x_block0, x_block1, x_block2, x_block3, x_block4, x_block5 = features[0], features[3], features[4], features[6], features[8], features[12]
...
class Encoder(nn.Module):
    def __init__(self, pretrained_=False):
        ...
        self.original_model = models.densenet169( pretrained=pretrained_ )
