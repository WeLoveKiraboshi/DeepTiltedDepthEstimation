...
import torchvision
import os
from models.PartialConv_v2 import PartialConv
...
class ResnetUnetHybridPartialConv_v2(nn.Module):
    def __init__(self, block=Bottleneck, layers=[3, 4, 6, 3],pretrained=False):
        self.inplanes = 64

        # resnet layers
        super(ResnetUnetHybridPartialConv_v2, self).__init__()
        ...
        self.network_name = 'ResnetUnetHybrid_pconv_v2'
        if pretrained:
    ...
    def forward(self, x, mask):
        #return self.resnet18(x), mask



        # rgb_frame_input = x[0].detach().cpu().permute(1, 2, 0)
        # plt.imshow(rgb_frame_input)
        # plt.show()
        ...
        #visualize_mask(mask, layer='Decode conv1')
    ...
    def load_weight_resnet50(self):
        ...
        own_state['layer1.0.downsample.1.BatchNorm2d.running_mean'].copy_(resnet50_state['layer1.0.downsample.1.running_mean'])
        own_state['layer1.0.downsample.1.BatchNorm2d.running_var'].copy_(resnet50_state['layer1.0.downsample.1.running_var'])
        own_state['layer1.0.downsample.1.BatchNorm2d.num_batches_tracked'].copy_(resnet50_state['layer1.0.downsample.1.num_batches_tracked'])
        ...
        own_state['layer2.0.downsample.1.BatchNorm2d.running_mean'].copy_(resnet50_state['layer2.0.downsample.1.running_mean'])
        own_state['layer2.0.downsample.1.BatchNorm2d.running_var'].copy_(resnet50_state['layer2.0.downsample.1.running_var'])
        own_state['layer2.0.downsample.1.BatchNorm2d.num_batches_tracked'].copy_(resnet50_state['layer2.0.downsample.1.num_batches_tracked'])
        ...
        own_state['layer3.0.downsample.1.BatchNorm2d.running_mean'].copy_(resnet50_state['layer3.0.downsample.1.running_mean'])
        own_state['layer3.0.downsample.1.BatchNorm2d.running_var'].copy_(resnet50_state['layer3.0.downsample.1.running_var'])
        own_state['layer3.0.downsample.1.BatchNorm2d.num_batches_tracked'].copy_(resnet50_state['layer3.0.downsample.1.num_batches_tracked'])
        ...
        own_state['layer4.0.downsample.1.BatchNorm2d.running_mean'].copy_(resnet50_state['layer4.0.downsample.1.running_mean'])
        own_state['layer4.0.downsample.1.BatchNorm2d.running_var'].copy_(resnet50_state['layer4.0.downsample.1.running_var'])
        own_state['layer4.0.downsample.1.BatchNorm2d.num_batches_tracked'].copy_(resnet50_state['layer4.0.downsample.1.num_batches_tracked'])
