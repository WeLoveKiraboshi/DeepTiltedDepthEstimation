...
class PartialConv(nn.Module):
    ...
    def forward(self, input, mask):
        ...
        print(1/mask_sum)
        print('mask_ratio max = {} min = {}'.format(torch.amax(1/mask_sum), torch.amin(1/mask_sum)))
...
class PConvUNet(nn.Module):
    def __init__(self, layer_size=4, input_channels=3, output_channels=1, upsampling_mode='nearest'):
        super().__init__()
